...
const createCountryTable = () => {
  // let db1 = new sqlite3.Database('./gold_medals.sqlite', sqlite3.OPEN_READWRITE, (err) => {
  //   if (err) {
  //     console.error(err.message);
  //   }
  //   console.log('Connected to the Gold Medals database.')
  // })

  // db1.run(`CREATE TABLE Country (
  //           name TEXT NOT NULL, 
  //           code TEXT NOT NULL,
  //           gdp INTEGER,
  //           population INTEGER);`)
  ...
  //     console.error(err.message);
  //   }
  //   console.log('Closed connection to the Gold Medals database.')
  // })
  ...
  if (field) {
    ...
    return (
      ...
      medal_per_sport AS (
          ...
          FROM GoldMedal
          GROUP BY sport
          HAVING country = '${country}' AND count IS NOT NULL
      )
